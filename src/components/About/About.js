...
function About() {
  return (
    <Container fluid className="about-section">
      <Container style={{border:'solid',marginBlock:'auto'}}>
        ...
        <Row className="skill-tools-wrapper">
          ...
          <Col className="skill-wrapper">
            <h1 className="project-heading">
              <strong className="purple">Tools</strong> I used  And  Also use
            </h1>
            {TOOLS.map((tool, index) => (
              <ul key={index} className="tool-name" style={{color:"GrayText"}}>
                <li>{tool}</li>
              </ul>
            ))}
          </Col>
